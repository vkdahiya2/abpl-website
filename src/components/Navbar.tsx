      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-[70px]">
          ...
          <Link href="/" className="flex items-center gap-3 group">
            <div className="w-11 h-11 rounded-xl bg-[#1C2B4A] flex items-center justify-center shadow-md
                            group-hover:bg-[#C9A444] transition-colors duration-300">
          ...
          <div className="hidden lg:flex items-center gap-0.5">
            ...
            >
              ...
              >
                ...
                <ChevronDown
                  size={14}
                  className={`transition-transform duration-200 ${offerOpen ? "rotate-180" : ""}`}
                />
              </button>
      ...
      >
        <div className="bg-white border-t border-[#E5DECE] px-4 py-4 space-y-1">
          ...
          >
            ...
            <ChevronDown
              size={16}
              className={`transition-transform ${mobileOfferOpen ? "rotate-180" : ""}`}
            />
          </button>
